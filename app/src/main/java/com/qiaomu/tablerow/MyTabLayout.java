...
public class MyTabLayout extends HorizontalScrollView {
     ...
     * <li>Set our {@link MyTabLayout.OnTabSelectedListener} which will forward
     ...
     */
    public MyTabLayout setupWithViewPager(@NonNull ViewPager viewPager) {
     ...
     */
    public MyTabLayout setTabsFromPagerAdapter(@NonNull PagerAdapter adapter) {
        removeAllTabs();
    ...
    public static final class Tab {
        ...
        private final MyTabLayout mParent;

        Tab(MyTabLayout parent) {
            mParent = parent;
        }
    ...
    public MyTabLayout setTabMargin(int margin) {
    ...
    public MyTabLayout setOnMaterialTabSelectedListener(MaterialTabSelectedListener listener1) {
